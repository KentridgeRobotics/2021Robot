...
public class ChomperDownPIDCommand extends PIDCommand {
  ...
  public ChomperDownPIDCommand(final ChomperSubsystem chomperSubsystem) {
    super(
        ...
        () -> chomperSubsystem.getChomperTargetDown(),
    ...
    SmartDashboard.putBoolean("ChomperDownPID running", false);
  ...
  public void end(boolean interrupted) {
    ...
    logger.info("Stopping Chomper Down PID Command");
    SmartDashboard.putBoolean("ChomperDownPID running", false);
  }
  ...
  public void initialize() {
    ...
    logger.info("Started Chomper Down PID Command");
    SmartDashboard.putBoolean("ChomperDownPID running", true);
  }
}
